				...
				<div class="well well-sm">
					 ...
					 <div class="panel panel-success"  id="tabCate" >
						<div class="panel-heading" >
							<span class="iconTitle" > <img src="images/icons/Folder-32.png" class="img-responsive" />ประเภทสินค้า</span>
						</div>
							<div class="panel-body table-responsive" >
										<table class='table table-condensed' id='cateList'> <!-- table-bordered -->
...
<div class="modal fade" id="modaldialog" tabindex="-1" role="dialog" aria-labelledby="modaltitle">
  <div class="modal-dialog" role="document">
	...
	<script src="js/category_manage.js" ></script>
</body>