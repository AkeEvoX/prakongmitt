...
if($type=="load")
{
	...
	$query = "select t1.*,t2.prodName,t2.prodIcon from productlist t1 left join product t2 on t1.prodid=t2.prodid where prodgroupid=".$groupid." ";
	$call = $consqli->query($query);
